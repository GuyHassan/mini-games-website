...
import spriteImage from '../../assets/fruits-icons.png';
...
export const SpriteIcon = styled('div').attrs({ className: 'guy' })<{ x: number; y: number }>`
    width: 100px; /* Set the width of the sprite */
    height: 100px; /* Set the height of the sprite */
