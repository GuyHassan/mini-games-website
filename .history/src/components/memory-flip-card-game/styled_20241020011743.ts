...
const ModeGameButtonsContainer = styled(Stack)(({ direction = 'row' }) => ({
  gap: '16px',
  flexDirection: direction, // Use flexDirection directly, but ensure the direction prop is passed correctly
}));
